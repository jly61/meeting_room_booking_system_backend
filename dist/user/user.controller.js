...
const refesh_token_vo_1 = require("./vo/refesh-token.vo");
...
let UserController = class UserController {
    ...
    async refresh(token) {
        try {
            ...
            const accessToken = this.makeToken(user, this.configService.get('jwt_access_token_expires_time') || '30m');
            const refreshToken = this.jwtService.sign({
                userId: user.id,
            }, {
                expiresIn: this.configService.get('jwt_refresh_token_expires_time') || '7d',
            });
            const vo = new refesh_token_vo_1.RefreshTokenVo();
    ...
    async list(username, nickName, email, pageNumber, pageSize) {
        return await this.userService.findUsersByPage(username, nickName, email, pageNumber, pageSize);
    }
    async upload(file) {
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({
        status: common_1.HttpStatus.OK,
        description: '刷新成功',
        type: refesh_token_vo_1.RefreshTokenVo,
    }),
...
__decorate([
    ...
    __param(3, (0, common_1.Query)('pageNumber', new common_1.DefaultValuePipe(1), (0, utils_1.generateParseIntPipe)('pageNumber'))),
    __param(4, (0, common_1.Query)('pageSize', new common_1.DefaultValuePipe(10), (0, utils_1.generateParseIntPipe)('pageSize'))),
    __metadata("design:type", Function),
    ...
    (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('file', {
        ...
        fileFilter(req, file, cb) {
            ...
            if (['.png', '.jpg', '.gif', 'jpeg', '.svg'].includes(extname)) {
                ...
                cb(new common_1.BadRequestException('只能上传图片'), false);
            }
        },
        limits: {
